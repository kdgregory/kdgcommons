...
public class StringUtil
{
    ...
    /**
     *  A flexible substring that can return left or right substrings. Makes
     *  a best effort if the starting offset is outside of the string bounds.
     *  <p>
     *  Examples:
     *  <p>
     *  <ul>
     *  <li> <code>substr("foo", 0, 2)</code> is <code>"fo"</code>
     *  <li> <code>substr("foo", 0, 1000)</code> is <code>"foo"</code>
     *  <li> <code>substr("foo", 999, 1000)</code> is <code>""</code>
     *  <li> <code>substr("foo", -1, 2)</code> is <code>"o"</code>
     *  <li> <code>substr("foo", -3, 2)</code> is <code>""</code>
     *  </ul>
     *
